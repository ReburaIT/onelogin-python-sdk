...
class SetUserStateRequest(object):
    ...
    @property
    def state(self):
        """Gets the state of this SetUserStateRequest.  # noqa: E501

        Unapproved: 0 Approved (licensed): 1 Rejected: 2 Unlicensed: 3  # noqa: E501

        :return: The state of this SetUserStateRequest.  # noqa: E501
        :rtype: int
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this SetUserStateRequest.

        Unapproved: 0 Approved (licensed): 1 Rejected: 2 Unlicensed: 3  # noqa: E501

        :param state: The state of this SetUserStateRequest.  # noqa: E501
        :type: int
        """
