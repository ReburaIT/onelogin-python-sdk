...
class EventsApi(object):
    ...
    def get_event_types(self, **kwargs):  # noqa: E501
        ...
        Returns a list of event types  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_event_types_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EventTypesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_events(self, **kwargs):  # noqa: E501
        ...
        Returns a list of events. Supports filtering and paging.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_events_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'created_at', 'directory_id', 'event_type_id', 'id', 'resolution', 'since', 'until', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'event_type_id' in params:
            query_params.append(('event_type_id', params['event_type_id']))  # noqa: E501
        if 'id' in params:
